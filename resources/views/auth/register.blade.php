                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('Phone number') is-invalid @enderror" name="name" value="{{ old('Phone number') }}" required autocomplete="name" autofocus placeholder="Phone number">
